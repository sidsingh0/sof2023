...
<head>
  ...
  <meta name="description"
    content="Siddharth Ovalekar Foundation is a leading NGO in Thane, Maharashtra, dedicated to empowering lives through successful placements and job opportunities. Join us in making a difference." />
  ...
  <meta name="og:title"
    content="Siddharth Ovalekar Foundation | Empowering Lives through Placements and Jobs in Thane, Maharashtra" />
  <meta name="og:description"
    content="Join Siddharth Ovalekar Foundation in Thane, Maharashtra, and be part of our mission to empower lives through successful placements and job opportunities." />
  ...
  <!-- Google Fonts -->
  <link
    href="https://api.fontshare.com/v2/css?f[]=switzer@600,800,900,700,400,300,500&f[]=satoshi@900,800,600,700,500,300,400&display=swap"
    rel="stylesheet" />
  <!-- Vendor CSS Files -->
  ...
  <footer id="footer">
    <div class="container d-md-flex py-4" style="align-items: center">
      ...
      <div class="social-links text-center text-md-end pt-3 pt-md-0">
        <a href="https://www.facebook.com/SiddharthDilipOvalekar?mibextid=ZbWKwL" class="facebook"><i
